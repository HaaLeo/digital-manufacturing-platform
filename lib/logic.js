...
function confirmTransaction(transferValues) {
        ...
        var price =  transaferValues.blueprintCopy.blueprintMaster.price
        cashBuyer.value = cashBuyer.value - price;
        cashSeller.value = cashSeller.value - price;
    
        //update blueprint attributes
        transferValues.blueprintCopy.owner = transferValues.buyer;
...
function requestBlueprint(buyingInfo) {
    ...
    blueprintCopy.owner = blueprintMaster.owner
...
function addNewBlueprintMaster(newBlueprintMaster) {
    var blueprintMaster = getFactory().newResource(NS, 'Product', newBlueprintMaster.blueprintCopyID);
