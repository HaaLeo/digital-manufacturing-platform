...
function evaluateReport(jobInfo){
    ...
    // TODO get File from IPFS and parse json

    var qualityRequirementPressure = 1000;
    var qualityRequirementTemperature = 300;

    var qualityReportPressure = 500;
    var qualityReportTemp = 100;

    var requirementsMet = false;
    debugger;
    if (qualityRequirementPressure>qualityReportPressure && qualityRequirementTemperature>qualityReportTemp){
        debugger;
