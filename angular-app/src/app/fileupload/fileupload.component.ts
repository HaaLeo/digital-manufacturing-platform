...
export class FileuploadComponent {
 ...
 getChecksum() {
  ...
  async postBCDB(pressure, peakTemperature, description, ownerID) {
    return await masterAssetBigchain(this.acceptedFile, pressure, peakTemperature, description, ownerID)
  }
